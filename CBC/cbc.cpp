...
int main()
{
    ...
    string outputImage = "encrypted_cbc.bmp";
    ...
    // Encrypt the image data using AES in CBC mode
    ...
    for (size_t i = 0; i < dataSize; i += 16)
    {
        ...
        PrintState("Input Block after XOR", in);
    ...
    cout << "\nCBC Mode Encryption complete. Encrypted image saved as " << outputImage << endl;
